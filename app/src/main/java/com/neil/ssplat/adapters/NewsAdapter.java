package com.neil.ssplat.adapters;
...
import com.neil.ssplat.R;
import com.neil.ssplat.model.NewsArticle;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NewsAdapter.NewsViewHolder holder, int position) {
        ...
        holder.tvDesCription.setText(articles.get(position).getContent().toString());
